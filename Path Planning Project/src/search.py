...
def __addToFrontier__(robot, nodeToAdd):
...
def computeNextStep(robot, tiles):
    ...
    for i in range(len(robot.frontier)):
        if robot.frontier[i] is BlankTile and (robot.frontier[i].costsFromStart[robot.robotID] + robot.frontier[i].estCostToGoal) < (leastCostNode.costsFromStart[robot.robotID] + leastCostNode.estCostToGoal):
            index = i
    ...
    if (leastCostNode.xPos > 0 and leastCostNode.xPos < len(tiles[0]) - 1) and (leastCostNode.yPos > 0 and leastCostNode.yPos < len(tiles) - 1):
        ...
        if type(tiles[leastCostNode.yPos][leastCostNode.xPos - 1]) == BlankTile:
            ...
            __addToFrontier__(robot, tiles[leastCostNode.yPos][leastCostNode.xPos - 1])
        ...
        if type(tiles[leastCostNode.yPos - 1][leastCostNode.xPos]) == BlankTile:
            ...
            __addToFrontier__(robot, tiles[leastCostNode.yPos - 1][leastCostNode.xPos])
